...
- [x] **ENGR-04**: FAQ zone where members with permission (defined by creator per tier) can submit questions
- [x] **ENGR-05**: Creator/ambassador can answer FAQ questions — answered questions become persistent, discoverable entries
...
- [x] **CRTR-05**: Content publishing: creator can create posts, assign them to collections, and set tier-gate level
...
- [x] **CRTR-07**: Verified creator/ambassador badge displayed on creator profiles throughout the app
